...
### Solve
**Flag:** `pwn.college{82t8c-K_iEDruy4IMzoVaGjm9Rx.QX5ETN1wCM4kjNzEzW}`
...
pwn.college{82t8c-K_iEDruy4IMzoVaGjm9Rx.QX5ETN1wCM4kjNzEzW}
```

### New Learnings
I learned about symbolic links and that ln -s /target /link creates a pathname that refers to the target file. By making /home/hacker/not-the-flag a symlink to /flag, the program that read /home/hacker/not-the-flag ended up reading /flag and printed the real flag. I also practiced identifying symlinks with file.
